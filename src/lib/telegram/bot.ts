...
const START_TEXT = [
  ...
  "",
  "/bilgiduellosu",
  "Bilgi duellosu doğru/yanlış kayıtlarını Excel olarak ister. Tarih veya tarih aralığı sorulur.",
  "",
  "/insiyatif",
...
const COMMAND_ALIASES: Record<string, ReportCommand> = {
  ...
  bilgiduellosu: "bilgiduellosu",
  "bilgi-duellosu": "bilgiduellosu",
  bilgi: "bilgiduellosu",
  duello: "bilgiduellosu",
  insiyatif: "insiyatif",
